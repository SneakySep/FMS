...
class OverviewModule extends DashboardModule
{
    ...
    protected array  $css      = ['css/modules/overview.css'];
    protected array  $js       = ['js/core/dom.js', 'js/core/storage.js', 'js/core/toast.js', 'js/modules/localdata.module.js', 'js/modules/ratings.module.js'];
    ...
    protected function prepare(): void
    {
        ...
        $this->vars = [
            ...
            'vehicleMeta'  => DemoData::vehicleMeta(),
