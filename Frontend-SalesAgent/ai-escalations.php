<?php
$pageTitle = 'AI Escalations - Priority Handling Logistics';
                    ...
                    <div class="p-6 flex items-start gap-5 hover:bg-slate-50/50 transition">
                        ...
                        <div class="flex-1">
                            ...
                            <div class="flex items-center gap-3 mt-4">
                                <button class="bg-brand-darkblue hover:bg-brand-navy text-white text-xs font-medium px-4 py-2 rounded-md transition shadow-xs">
                                    Accept & respond
                                </button>
