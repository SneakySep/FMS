<?php
$pageTitle = 'Contracts - Priority Handling Logistics';
...
<main class="flex-1 flex flex-col min-w-0 bg-[#f4f7fa] dark:bg-[#0a1628]">
        ...
        <header class="bg-white border-b border-gray-200 px-8 py-4 flex items-center justify-between sticky top-0 z-10">
            <h2 class="text-2xl font-bold italic text-slate-900 tracking-wide">Contract</h2>
        ...
        <div class="p-8 w-full">
            ...
            <div class="bg-white rounded-xl border border-gray-300/80 shadow-sm overflow-hidden">
                ...
                <div class="p-6 border-b border-gray-200 flex justify-between items-start">
                    <div>
                        <h3 class="text-xl font-bold text-slate-900 mb-0.5">Contracts</h3>
                        <p class="text-xs text-gray-400">Signed and pending service agreements</p>
                    </div>
                    ...
                    <table class="w-full text-left border-collapse">
                        <thead>
                            <tr class="border-b border-gray-200 text-xs font-semibold text-gray-400 tracking-wider">
                                <th class="py-3.5 px-6">CONTRACT</th>
                                <th class="py-3.5 px-6">CUSTOMER</th>
                                <th class="py-3.5 px-6">VALUE</th>
                                <th class="py-3.5 px-6">STATUS</th>
                                <th class="py-3.5 px-6 text-right">SIGNED</th>
                            </tr>
                        </thead>
                        <tbody class="divide-y divide-gray-200 text-sm text-slate-800">
                            <!-- Row 1 -->
                            <tr class="hover:bg-slate-50 transition">
                                <td class="py-4 px-6 font-semibold text-slate-900">CT-2026-0091</td>
                            ...
                            <!-- Row 2 -->
                            <tr class="hover:bg-slate-50 transition">
                                <td class="py-4 px-6 font-semibold text-slate-900">CT-2026-0090</td>
                                <td class="py-4 px-6 font-semibold text-slate-800">Subic Freeport Traders</td>
                                <td class="py-4 px-6 font-bold text-slate-900">₱88,000</td>
                                <td class="py-4 px-6">
                                    <span class="bg-emerald-100 text-emerald-700 text-xs font-semibold px-2.5 py-1 rounded-full inline-flex items-center gap-1.5">
                                        <span class="w-1.5 h-1.5 rounded-full bg-emerald-500"></span> Signed
                                    </span>
                                </td>
                                <td class="py-4 px-6 text-right text-xs text-slate-600 font-medium">Jul 24, 2026</td>
                            </tr>

                            <!-- Row 3 -->
                            <tr class="hover:bg-slate-50 transition">
                                <td class="py-4 px-6 font-semibold text-slate-900">CT-2026-0088</td>
                                <td class="py-4 px-6 font-semibold text-slate-800">Robles Cargo Corp.</td>
                                <td class="py-4 px-6 font-bold text-slate-900">₱120,000</td>
                                <td class="py-4 px-6">
                                    <span class="bg-amber-100 text-amber-800 text-xs font-semibold px-2.5 py-1 rounded-full inline-flex items-center gap-1.5">
                            ...
                            <!-- Row 4 -->
                            <tr class="hover:bg-slate-50 transition">
                                <td class="py-4 px-6 font-semibold text-slate-900">CT-2026-0084</td>
                                <td class="py-4 px-6 font-semibold text-slate-800">Batangas Steelworks</td>
                                <td class="py-4 px-6 font-bold text-slate-900">₱210,000</td>
                                <td class="py-4 px-6">
