...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
  ...
  <div class="lg:col-span-2">
    <div class="bg-gradient-to-b from-indigo-50/60 to-purple-50/40 admin-chart-card p-6 rounded-2xl border border-slate-200/80 shadow-sm h-full">
      ...
      <!-- Bar Chart Canvas -->
      <div id="admin-revenue-chart" class="w-full h-[240px]"></div>
        </div>
  </div>
    ...
    <div class="bg-white p-6 rounded-2xl border border-slate-200/80 shadow-sm">
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div class="bg-indigo-50/50 border border-indigo-200/50 rounded-xl p-4 text-center">
          <div class="text-2xl font-bold text-indigo-600 mb-1">₱<?= number_format($revenue_current, 0) ?></div>
