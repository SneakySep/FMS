...
/* ==========================================================================
    ...
    Reads: $kpis (DemoData::kpis()), used for the two figures printed inside
    the copy, and $displayName for the banner greeting. Included from
    views/overview.php with the module's variables in scope.
...
?>
            ...
            <div class="lg:col-span-4 crm-card">
                ...
                <div class="crm-panel-body grid grid-cols-2 gap-3">
                    <a href="book.php" class="dlv-vehicle !flex-col !items-start !gap-2">
                    ...
                    <a href="tracking.php" class="dlv-vehicle !flex-col !items-start !gap-2">
                        ...
                        <span>
                            ...
                            <span class="block text-[10px] font-semibold" style="color: var(--fg-muted);"><?= (int) $kpis['active'] ?> routes moving</span>
                        </span>
                    </a>
                    <a href="fleet.php" class="dlv-vehicle !flex-col !items-start !gap-2">
                        ...
                        <span>
                            ...
                            <span class="block text-[10px] font-semibold" style="color: var(--fg-muted);"><?= (int) $kpis['fleetAvailable'] ?> vehicles free</span>
                        </span>
                    </a>
